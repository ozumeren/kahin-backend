...
class OptionController {
  async tradeOption(req, res) {
    ...
    try {
      ...
      // Fiyatları güncelle
      await this.updateOptionPrices(option, transaction);
  ...
  async getMyMarketOptionPositions(req, res) {
    try {
  ...
  async getOptionPositions(req, res) {
    try {
      const { optionId } = req.params;
  ...
  async updateOptionPrices(option, transaction) {
